    ...
    <template v-else>
      ...
      >
        <input
          ...
          type="file"
          multiple
          accept="image/*,video/*,application/x-shockwave-flash,application/vnd.adobe.flash.movie,application/zip"
          class="hidden"
          @change="onFileInput"
        />
        ...
        <p class="text-gray-400 dark:opacity-90 text-xs mt-1">
          Supported: JPG, PNG, GIF, WEBP, AVIF, HEIF, JXL, MP4, WEBM, MOV, PDF, SWF, ZIP
        </p>
      </div>
