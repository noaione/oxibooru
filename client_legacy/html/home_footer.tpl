<ul>
    ...
    </span><li>Build <a class='version' href='https://github.com/liamw1/oxibooru/commits/master'><%- ctx.version %></a><%- ctx.isDevelopmentMode ? " (DEV MODE)" : "" %> from <%= ctx.makeRelativeTime(ctx.buildDate) %></li><span class='sep'>
